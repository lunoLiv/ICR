...
def Limpar_Dados_02(local,caminho):
    ...
    for i in dados:
        ...
        try:
            sinistro = i[header.index('SINISTRO ')]
        except:
            sinistro = '-'
        ...
        entrada.append([pasta,sinistro,aviso,aluguel,tratativa,corretor,endereco,cidade,uf,imobiliaria,caminho])
    return entrada
...
pasta = [i for i in os.listdir() if i[0][0] == '0']
